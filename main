...
var appStyle = require('users/miguelchapela92/timeSeriesApp:appStyle');
var functions = require('users/miguelchapela92/timeSeriesApp:functions');
...
variablesPanel.add(ui.Label('Time series analysis apple orchard', appStyle.TITLE_STYLE));
